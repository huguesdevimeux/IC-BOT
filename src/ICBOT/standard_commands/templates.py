...
from ICBOT.constants.constants import Messages


class StandardMessage(AbstractStandardMessage):
    def __init__(self, title=None, content="", show_doc=True, colour=Colour.blue(), ) -> None:
        super().__init__(help_message=StandardCommands.HELP.help_message,
